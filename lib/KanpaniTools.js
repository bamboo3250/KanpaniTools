(function(){
    ...
    window.Kanpani = {
        ...
        updateDungeonFloor: function(body) {
            var endDefcon = null;
            if (body['Dungeon.update_defcon'] && body['Dungeon.update_defcon']['end_at']) {
                endDefcon = body['Dungeon.update_defcon']['end_at'] + ' GMT+0900';
            }
            KTPlayerManager.defconEndTime = endDefcon;
            KTPlayerManager.saveToLocalStorage();
            KTUIManager.startDungeonTimer();
        }
    }
