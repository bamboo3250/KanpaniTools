    ...
    window.KTUIManager = {
        ...
        getSkillDetails: function(skill) {
            ...
            for(var i=0;i<skill.effects.length;i++) {
                ...
                if (phase.long_distance == 1 && phase.magic != 1 && classId != '3') text += ' , Long';
                if (phase.magic == 3 || (phase.magic == 1 && classId != '8' && phase.skill_type == 1)) text += ', Surehit';
                ...
                if (phase.buffs) {
                    ...
                    for(var key in phase.buffs) {
                        ...
                        if (buff.params) {
                            ...
                            text += ' (+' + (buff.effect_value/(buff.buff_type == 'attack'?100:10)) + '%, ' + buff.period + ' turn(s))';
                        }
                    }
                }
