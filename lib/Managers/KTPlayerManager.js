(function(){
    ...
    window.KTPlayerManager = {
        ...
        updateTempItems: function(itemList) {
            for(var i=0;i<itemList.length;i++) {
                var item = itemList[i];
                this.tempItemDict[item.item_id] = item;
            }
        },

        getTempItem: function(itemId) {
            if (typeof this.tempItemDict[itemId] == 'undefined') return null;
            return this.tempItemDict[itemId];
        }
    }
})();