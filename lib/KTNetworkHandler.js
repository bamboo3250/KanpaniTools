...
KTNetworkHandler.handleRequest = function(request) {
    ...
    request.getContent(function(content, encoding) {
        ...
        KTNetworkHandler.handleCardSituationSceneRequest(url, body);
        KTNetworkHandler.handleCardSituationTextRequest(url, body);
    });
};
...
KTNetworkHandler.handleCardSituationSceneRequest = function(url, body) {
    var acceptedUrls = [
...
KTNetworkHandler.handleCardSituationTextRequest = function(url, body) {
    var acceptedUrls = [
