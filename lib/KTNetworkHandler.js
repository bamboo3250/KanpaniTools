    ...
    window.KTNetworkHandler = {
        ...
        handleRequest: function(request) {
            ...
            request.getContent(function(content, encoding) {
                ...
                self.handleRaidStartRoundRequest(url, body);
                self.handleQuestFinish(url, body);
                self.handleGetCardBook(url, body);
                self.handleLargeBossGetEquipment(url, body);
                self.handleProduceRequest(url, body);
                self.handleGachaSelect(url, body);
                self.handlePromote(url, body);

                self.handleEvent17083101Get(url, body);
            });
        },
        ...
        handleEvent17083101Get: function(url, body) {
            var acceptedUrls = [
        ...
        handleRaidStartRoundRequest: function(url, body) {
            var acceptedUrls = [
        ...
        handleLargeBossGetEquipment: function(url, body) {
            var acceptedUrls = [
        ...
        handleProduceRequest: function(url, body) {
            var acceptedUrls = [
        ...
        handleGachaSelect: function(url, body) {
            var acceptedUrls = [
        ...
        handlePromote: function(url, body) {
            var acceptedUrls = [
