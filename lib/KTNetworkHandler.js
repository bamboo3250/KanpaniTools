    ...
    window.KTNetworkHandler = {
        ...
        handleRequest: function(request) {
            ...
            request.getContent(function(content, encoding) {
                ...
                self.handleGetSupplyItemsAll(url, params, body, lang);
        ...
        handleGetBuildingRequest: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Territory.get_all_buildings&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleDungeonEnter: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Dungeon.enter&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleDungeonMove: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Dungeon.move&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleDungeonFloor: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Dungeon.top&_u=[0-9]+',
        ...
        handleDungeonScenario: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Dungeon.get_scenario&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleGachaDraw: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Gacha.draw_free&_u=[0-9]+',
                'http://[0-9a-z.\-]*/amf\\?_c=ItemBox.use&_u=[0-9]+',
                'http://[0-9a-z.\-]*/amf\\?_c=Gacha.draw&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleGetPRDescription: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=Territory.get_publicity_description&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;
        ...
        handleGetSupplyItemsAll: function(url, params, body, lang) {
            var acceptedUrls = [
                'http://[0-9a-z.\-]*/amf\\?_c=ItemBox.get_supply_items_all&_u=[0-9]+'
            ];
            if (!isExpectedRequest(url, acceptedUrls)) return;

            Kanpani.updateSupplyItems(body);
        }
