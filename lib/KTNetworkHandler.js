    ...
    window.KTNetworkHandler = {
        ...
        handleRequest: function(request) {
            ...
            request.getContent(function(content, encoding) {
                ...
                self.handleGachaDraw(url, body, lang);
                self.handlePromote(url, body, lang);
                
                self.handleDungeonFloor(url, body, lang);
                self.handleDungeonScenario(url, body, lang);
        ...
        handleDungeonScenario: function(url, body, lang) {
            var acceptedUrls = [
        ...
        handleGachaDraw: function(url, body, lang) {
            var acceptedUrls = [
            ...
            for(var i=0;i<this.drawTypes.length;i++) {
                console.log(url + " " + this.drawTypes[i] + " " + url.includes(this.drawTypes[i]))
                if (url.includes(this.drawTypes[i])) {
                    Kanpani.getDrawResult(body, this.drawTypes[i]);
                    break;
                }
            }
        },
